      ...
      <div key={decal} className="decal">
        <img src={decal + '.png'} alt="brand" onClick={() => handleDecalClick(decal)} />
          ...
          >
            ...
            {/* Preview button */}
            <button
              className="w-10 absolute top-0 right-28 hover:scale-90  text-white tooltip tooltip-success tooltip-bottom"
              data-tip="Preview"
              onClick={() => {
          ...
          >
            ...
            {/* Download button */}
            <button
              className="download-btn hover:scale-95 tooltip tooltip-success"
              data-tip="Download"
